...
class ReaderTest extends FlatSpec with ShouldMatchers {
  ...
  "the reader" should "convert the historical nav data to a collection of eft data" in {
    ...
    data.head shouldEqual ETFData(new DateTime(2016, 8, 30, 0, 0, 0), 166.99041, 27.248022, 0)
    data(52) shouldEqual ETFData(new DateTime(2016, 6, 15, 0, 0, 0), 146.693515, 24.077652, 0.06536)
    data.last shouldEqual ETFData(new DateTime(2009, 6, 18, 0, 0, 0), 100d, 20, 0)
  }
